...
contract MoodNftIntegrationTest is Test {
        string public constant HAPPY_SVG_IMAGEURI =
...
function setUp() public {
    ...
    function testFlipTokenToSadIntegration() public {
        ...
        assert(keccak256(abi.encodePacked(SAD_MOOD_URI)) == keccak256(abi.encodePacked(moodNft.tokenURI(0))));
    }
